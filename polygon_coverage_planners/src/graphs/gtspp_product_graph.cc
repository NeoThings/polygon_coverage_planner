...
bool GtsppProductGraph::solve(const Point_2& start, const Point_2& goal,
  ...
  return temp_gtspp_product_graph.getWaypoints(solution, waypoints, clustered_waypoints);
}
...
bool GtsppProductGraph::getWaypoints(const Solution& solution,
  ...
  // Get waypoints.
  return sweep_plan_graph_->getWaypoints(sweep_plan_solution, waypoints, clustered_waypoints);
}
